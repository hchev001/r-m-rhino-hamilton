  ...
  return (
    <nav>
      <div className="flex justify-between">
        <header className="text-mustard text-xl bg-greese bg-opacity-75 py-6 pl-4 flex-grow text-center">
          Rick & Morty Fan Site
        </header>
        <div
      ...
      >
        <li className="mb-12 w-full">
          <div className="hover:bg-mustard rounded-full flex justify-center text-white hover:text-gray-300 items-center">
            <svg
              id="pc-monitor"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
